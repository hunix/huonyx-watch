/**
 * Huonyx Watch – Gateway WebSocket Client
 * Implements the HoC Gateway Protocol for ESP32-S3
 * Connects via Tailscale funnel (HTTPS/WSS)
 */
...
public:
    ...
    void begin(const char* host, uint16_t port, const char* password, bool useSSL = true);
    void loop();
    void disconnect();
